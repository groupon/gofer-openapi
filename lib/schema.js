...
function objectTypeAnnotation({ properties = {}, required = [], }) {
    return t.objectTypeAnnotation(Object.entries(properties).map(([key, propSchema]) => Object.assign(t.objectTypeProperty(t.identifier(key), schemaToAnnotation(propSchema)), {

...
prog
    ...
    .option('-e, --extends <ClassName>', 'What class should generated one extend', 'Gofer')
...
const { args } = prog;
const { format, class: className, extends: extendsClassName, target, } = prog.opts();
const specStr = (0, fs_1.readFileSync)(args[0] || 0, 'utf8');
process.stdout.write((0, gofer_openapi_1.goferFromOpenAPI)(specStr, { className, extendsClassName, format, target }));

...
const { args } = prog;
const { format, class: className, extends: extendsClassName, } = prog.opts();
if (format !== 'ts') {
...
process.stdout.write((0, gofer_openapi_1.goferFromOpenAPI)(specStr, { className, extendsClassName }));

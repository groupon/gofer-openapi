...
function goferFromOpenAPI(openAPI, opts) {
    ...
    const klass = t.exportNamedDeclaration(t.classDeclaration(t.identifier(opts.className), opts.extendsClassName ? t.identifier(opts.extendsClassName) : null, t.classBody(endpoints)));
    return (0, generator_1.default)(t.program([...typeDecls, klass])).code;
}

...
function goferFromOpenAPI(classTemplate, openAPI) {
    ...
    const endpointsTS = stripBraces((0, generator_1.default)(t.classBody(endpoints)).code);
    const typeDecls = (0, type_decls_1.default)(spec.components);
    const typeDeclsTS = stripBraces((0, generator_1.default)(t.blockStatement(typeDecls)).code);

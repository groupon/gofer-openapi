...
function goferFromOpenAPI(openAPI, opts) {
    ...
    const klass = t.exportNamedDeclaration(t.classDeclaration(t.identifier(opts.className), t.identifier('Gofer'), t.classBody(endpoints)));
    const ts = (0, generator_1.default)(t.program([goferImport, ...typeDecls, klass])).code;
